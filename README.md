...
Notably, this repository contains a Jupyter notebook *Survey_results.ipynb*. The notebook analyses and graphically represents the data contained within the data sheet, extracted as pandas dataframes. The graphical representations include bar charts, pie charts and stacked bar charts, using matplotlib. Where applicable, data is sorted according to counts.
